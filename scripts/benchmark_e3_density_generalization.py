"""E3 obstacle-density generalization benchmark."""
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Run E3 obstacle-density PyFlyt benchmark.")
    p.add_argument(
        "--suite-config",
        type=str,
        default="configs/benchmark/e3_density_generalization_suite.yaml",
    )
